...
public final class DequantQ5KKernel: Sendable {
    ...
    public func dequantise(
        ...
        let threadWidth = max(
            1,
            min(superBlockCount, dequantPipeline.maxTotalThreadsPerThreadgroup)
        )
